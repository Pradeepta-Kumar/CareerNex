...
import { create_resume } from "@/store/resume-slice";
...
const Resume = () => {
  ...
  const { resumeContent } = useSelector((state) => state.resume);
  ...
  const handleSubmit = async (e) => {
    ...
    dispatch(create_resume({ formData, id: userId })).then((data) => {
      if (data?.payload?.success) {
        toast.success("Resume created", {
          description:
            "Successfully created your resume based on your details",
        });
      } else {
        toast.error("Error creating Resume", {
          description: "Couldn't create resume using your details",
        });
      }
    });
  };
  ...
  return (
    <div className="w-full py-6 md:pt-24 lg:py-26 bg-black text-white">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-12 flex justify-around max-w-[600px] items-center mx-auto">
            Help CareerNex generate your Resume using your details
          </h2>
          ...
          >
            <div className="flex justify-around items-center gap-20 w-[80%] mx-auto">
              ...
              <div className="w-full">
                ...
                <Input
                  ...
                  onChange={handleChange}
                />
                <Label className=" text-white m-4">Achievements</Label>
                <Input
                  type="text"
            ...
            <div className="mt-8">
              ...
              >
                Generate Resume <ArrowRightCircle />
              </Button>
            </div>
          </form>
          {resumeContent ? (
